        ...
        if (editor) {
            ...
            if (title !== undefined) {
                if (title === '') {
                    ...
                    const newSnippetUrl = `https://www.codever.dev/my-snippets/new?code=${selectedText}&title=${title}
					&tags=${tags}&workspace=${workspace}&file=${file}&location=${fileSystemPath}&ext=vscode&initiator=vscode`;
